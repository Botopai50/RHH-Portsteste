...
## Installation
This wrapper is compatible with all UFO 50 versions up to 1.9.5, the latest. Purchase the game on Steam and copy all the data to `ports/ufo50/assets`. On first run the game will be patched.
